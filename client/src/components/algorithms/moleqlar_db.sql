...
--
-- Name: TABLE graphs; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.graphs IS 'Table to store user''s graphs';


--
-- Name: graph_graph_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.graphs ALTER COLUMN graph_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.graph_graph_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: graphs graph_graph_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.graphs
    ADD CONSTRAINT graph_graph_id_key UNIQUE (graph_id);


--
-- Name: graphs graph_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: graphs graph_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.graphs
    ADD CONSTRAINT graph_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(user_id);
...
--
-- Name: graphs; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE graphs; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.graphs TO anon;
GRANT ALL ON TABLE public.graphs TO authenticated;
GRANT ALL ON TABLE public.graphs TO service_role;


--
-- Name: SEQUENCE graph_graph_id_seq; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE public.graph_graph_id_seq TO anon;
GRANT ALL ON SEQUENCE public.graph_graph_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.graph_graph_id_seq TO service_role;
